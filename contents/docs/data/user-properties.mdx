...
Similarly to how you set properties, you can use `$unset` to remove properties by calling `capture` and including an array of properties keys:
...
To view properties for a particular user, go to "[Persons & Groups](https://app.posthog.com/persons)" in the PostHog app. Then, click on any person in the list to view their properties. You can also add or delete properties using this interface.
