...
To view properties for a particular user, go to "[Persons & Groups](https://app.posthog.com/persons)" in the PostHog app. Then, click on any person in the list to view their properties. You can also add or delte properties using this interface.
